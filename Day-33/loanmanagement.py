    ...
    def display_statement(self):
        ...
        if not self.repayment_history:
            ...
            for i in range(len(self.repayment_history)):
                print(f"Payment {i+1}           : {self.repayment_history}")
...
teja = Customer(1,'teja','teja@gamil.com',9087654321,21,50000,750)
teja.display_customer()
print("Loan Eligibility:",teja.check_eligibility())

hema = Customer(1,'hema','hema@gamil.com',9087654322,20,2500,750)
hema.display_customer()
print("Loan Eligibility:",hema.check_eligibility())
